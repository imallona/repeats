...
```{r}
saveRDS(d, file = params$seurat_output)
```
...
d[[flavour]]@meta.data$truth <- d[[flavour]]@meta.data$orig.ident
...
for (flavour in names(d)) {
    ...
    for (res in resolutions) {
        ...
        known <- rownames(d[[flavour]]@meta.data[d[[flavour]]@meta.data$truth != 'unknown',])
