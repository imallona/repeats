...
params = list(identifier = "GSE121861_kumar_mouse", 
                     genes_cellranger = "/scratch/imallona/repeats_sc/runs/GSE121861_kumar_mouse/SRR8165412/cellranger_standard/outs/filtered_feature_bc_matrix/barcodes.tsv.gz", 
                     repeats_cellranger = "/scratch/imallona/repeats_sc/runs/GSE121861_kumar_mouse/SRR8165412/cellranger_repeats/outs/filtered_feature_bc_matrix/barcodes.tsv.gz", 
                     repeats_featurecounts_multi = "None", 
                     repeats_featurecounts_unique = "None",
                     repeats_only_featurecounts_control_multi = "None", 
                     repeats_only_featurecounts_control_unique = "/scratch/imallona/repeats_sc/runs/GSE121861_kumar_mouse/SRR8165412/count_repeats_on_cellranger_standard_not_overlapping_genes/unique_reads/GSE121861_kumar_mouse_repeats_not_overlapping_genes.counts.gz",
                     seurat_output = "/scratch/imallona/repeats_sc/runs/GSE121861_kumar_mouse/SRR8165412/SRR8165412_chromium_regress_nCount_FALSE_nFeature_FALSE.rds", 
                     aris_output = "/scratch/imallona/repeats_sc/runs/GSE121861_kumar_mouse/SRR8165412/SRR8165412_aris_regress_nCount_FALSE_nFeature_FALSE.rds", 
                     regress_genes_nCount = "FALSE", 
...
for (item in names(d)) {
    ...
    ## if the num cells is too low, manually set a low perplexity; 30 is default
    d[[item]] <- RunTSNE(d[[item]], dims = NUM_PCS, check_duplicates = FALSE,
                         perplexity = ifelse(nrow(d[[item]]@meta.data) >= 100,
                                             yes = 30,
                                             no = 5))
}
...
```{r, results = 'asis', fig.width = 4, fig.height = 4, cache = FALSE, error = TRUE}
aris <- list()
i <- 1
for (genes_res in seq(0.2, 2, 0.2)) {
...
```{r, fig.width = 6, fig.height = 6, error = TRUE}
