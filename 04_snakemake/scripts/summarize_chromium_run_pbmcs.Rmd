...
params <- list(identifier = "pbmc8k", 
                     genes_cellranger = "/home/imallona/repeats_sc/runs/pbmc8k/cellranger_standard/outs/filtered_feature_bc_matrix/barcodes.tsv.gz", 
                     repeats_cellranger = "/home/imallona/repeats_sc/runs/pbmc8k/cellranger_repeats/outs/filtered_feature_bc_matrix/barcodes.tsv.gz", 
                     markers_output = "/home/imallona/repeats_sc/runs/pbmc8k/pbmc8k_markers_regress_nCount_FALSE_nFeature_FALSE.rds", 
                     repeats_featurecounts_multi = "/home/imallona/repeats_sc/runs/pbmc8k/count_repeats_on_cellranger_standard/multimappers/pbmc8k_repeats.counts.gz", 
                     repeats_featurecounts_unique = "/home/imallona/repeats_sc/runs/pbmc8k/count_repeats_on_cellranger_standard/unique_reads/pbmc8k_repeats.counts.gz",
                     repeats_only_featurecounts_control_multi = "/home/imallona/repeats_sc/runs/pbmc8k/count_repeats_on_cellranger_standard_not_overlapping_genes/multimappers/pbmc8k_repeats_not_overlapping_genes.counts.gz", 
                     repeats_only_featurecounts_control_unique = "/home/imallona/repeats_sc/runs/pbmc8k/count_repeats_on_cellranger_standard_not_overlapping_genes/unique_reads/pbmc8k_repeats_not_overlapping_genes.counts.gz",
                     seurat_output = "/home/imallona/repeats_sc/runs/pbmc8k/pbmc8k_pmbc_chromium_regress_nCount_FALSE_nFeature_FALSE.rds", 
                     aris_output = "/home/imallona/repeats_sc/runs/pbmc8k/pbmc8k_aris_regress_nCount_FALSE_nFeature_FALSE.rds", 
                     regress_genes_nCount = "FALSE", 
                     regress_genes_nFeature = "FALSE",
                     repeats_bowtie_unique = "/home/imallona/repeats_sc/runs/pbmc8k/bowtie_repeatome/unique_reads/all_cells_repeats.counts.gz", 
                     ...
                     cobra_output = "/home/imallona/repeats_sc/runs/pbmc8k/pbmc8k_cobra_regress_nCount_FALSE_nFeature_FALSE.rds")
...
if (params$repeats_featurecounts_multi != "None") {
    ...
    tmp <- data.table::fread(params$repeats_featurecounts_multi, sep = '\t', sep2 = ' ',
                             header = TRUE,
    ...
    tmp <- tmp[,-1]
    tmp <- tmp[,grep('Length', colnames(tmp), invert = TRUE)]
...
```{r check_qc, results = 'asis', fig.width = 8, fig.height = 4}
for (item in names(d)) {
    tryCatch({
        cat("### ", item, "\n\n")
...
for (flavour in names(d)) {
    ...
    for (res in resolutions) {
        ...
        hung[[flavour]][[res]] <- hungarian_weber_with_labels(
            as.factor(d[[flavour]]@meta.data[known, res]),
...
```{r maxf1, fig.width = 5, fig.height = 5}
