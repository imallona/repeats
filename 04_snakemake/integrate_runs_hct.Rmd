---
title: "Across samples report - HCT116"
...
params <- list(chromium1 = '/home/imallona/repeats_sc/runs/SRR10974767/SRR10974767_chromium_regress_nCount_FALSE_nFeature_FALSE.rds',
               chromium2 = '/home/imallona/repeats_sc/runs/SRR10974769/SRR10974769_chromium_regress_nCount_FALSE_nFeature_FALSE.rds',
...
## cr cellranger
## fc featurecounts
for (rds in grep('regress', names(params), invert = TRUE, value = TRUE)) {
    ...
    d[[sapply(strsplit(dirname(params[[rds]]), .Platform$file.sep),
               function(x) return(x[6]))]] <- readRDS(file = params[[rds]])
}
```
...
for (item in names(combined)) {
    ...
    print(DimPlot(combined[[item]], reduction = "pca", group.by = 'orig.ident'))
