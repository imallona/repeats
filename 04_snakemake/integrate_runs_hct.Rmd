...
params <- list(chromium1 = '/home/imallona/repeats_sc/runs/SRR10974767/SRR10974767_chromium_regress_nCount_FALSE_nFeature_FALSE',
               chromium2 = '/home/imallona/repeats_sc/runs/SRR10974769/SRR10974769_chromium_regress_nCount_FALSE_nFeature_FALSE
...
for (item in names(d[[1]])) {
    combined[[item]] <- merge(d[[1]]$item, y = d[[2]]$item,
                              add.cell.ids = c(names(d)[1],
                                               names(d)[2]),
                              project = "hct_dnmts")

    combined[[item]] <- NormalizeData(combined[[item]],
