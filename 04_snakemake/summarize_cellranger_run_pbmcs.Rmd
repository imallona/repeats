...
for (flavour in names(d)) {
    ...
    for (res in resolutions) {
        ...
        ## c(sprintf('genes_%s (n=%s)', res,
        ##                        length(unique(d[[flavour]]@meta.data[known, res]))),
        ##                sprintf('scina_%s (n=%s)', 'scina',
        ##                        length(unique(d[[flavour]]@meta.data[known, 'scina']))),
        ##                adjustedRandIndex(d[[flavour]]@meta.data[known, res],
        ##                                  d[[flavour]]@meta.data[known, 'scina']))
...
Genes clustering! iCOBRA-based PR curves
...
## sorting by max F1, any flavour
unique(as.character(maxF1$cell[order(maxF1$max_F1)]))
