...
palettes$multimapper <- data.frame(
    id = c('unique', 'multi', 'deduplicated'),
    color = c('#85BDA6', "#2F4B26", "#BEDCFE"))
...
## ggplot(mapping, aes(y=mapped, x = dataset)) +
##     geom_point(aes(col = mapper, shape = counter)) +
##     facet_grid(~analyte)+ 
...
## ggplot(mapping, aes(y=mapped, x = dataset)) +
##     geom_point(aes(col = mapper, shape = counter)) +
##     facet_grid(multimapping~analyte)+ 
##     theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
##     labs(title = "Mapping rates") +
##     facet_grid(counter~multimapping) + 
##     theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
##     labs(title = "Mapping rates") +
##     facet_grid(mapper~counter) + 
##     theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

```

Maybe better colored by technology?


```{r, fig.width = 6, fig.height =4}
## levels(mapping$dataset)
ggplot(mapping, aes(y= mapped *100, x = dataset)) +
    geom_point(aes(col = dataset, shape = multimapping)) +
