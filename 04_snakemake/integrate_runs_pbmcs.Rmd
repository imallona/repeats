...
palettes$analyte <- data.frame(
    id = c('repeats', 'genes', 'genes+repeats'),
    color = c('#157A6E', '#60615b', '#B4654A'))

palettes$overlap <- data.frame(
    id = c('overlap_allowed', 'no_overlap', 'alevin_decoy'),
...
annot$flavour[grepl('repeats', annot$flavour$id), 'analyte'] <- 'repeats'
annot$flavour[grepl('both', annot$flavour$id), 'analyte'] <- 'genes+repeats'

annot$flavour$analyte <- factor(annot$flavour$analyte,
                                levels = c('genes', 'genes+repeats', 'repeats'))
...
annot$flavour$overlap <- 'overlap'
annot$flavour[grepl('repeats_alevin', annot$flavour$id), 'overlap'] <- 'alevin_decoy'
annot$flavour[grepl('genes|both', annot$flavour$id), 'overlap'] <- 'NA'
annot$flavour[grepl('only', annot$flavour$id), 'overlap'] <- 'no_overlap'
...
merged <- merge(links, annot$flavour[,c('id', 'analyte', 'mapper',
                                       'overlap', 'multimapping', 'counter')],
                by.x = 'target', by.y = 'id')
...
ggplot(data = cobra,      
    ...
    geom_point() +
    scale_colour_manual(values = setNames(palettes$overlap$color,
                                          palettes$overlap$id)) +
    facet_grid(id~cell) + 
    theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
    xlab('unsup. clust. resolution') +
...
for (celltype in unique(markers$cluster)) {
    ...
    for (flavour in unique(markers[markers$cluster == celltype, 'flavour'])) {
        for (dataset in unique (markers[markers$flavour == flavour &
            ...
            annot[[celltype]][[paste(flavour, dataset,
    ...
    annot[[celltype]] <- do.call(rbind.data.frame, annot[[celltype]])
    colnames(annot[[celltype]]) <- c('flavour', 'dataset', 'celltype', 'num_markers')
    annot[[celltype]]$num_markers <- as.numeric(annot[[celltype]]$num_markers)
    rownames(annot[[celltype]]) <- paste(annot[[celltype]]$flavour,
                                         annot[[celltype]]$dataset,
                                         annot[[celltype]]$celltype)
    rownames(fc[[celltype]]) <- detected

    stopifnot(all(rownames(annot[[celltype]]) == colnames(fc[[celltype]])))
}
...
havoc <- havoc[,grep('repeats', colnames(havoc))]
## dim(havoc)
ham_d <- dist(t(havoc), method = 'binary')
hc <- hclust(ham_d, method = 'ward.D2')
...
<!-- ```{r} -->
<!-- for (ct in names(annot)) { -->
<!--     annot[[ct]]$num_markers <- as.numeric(annot[[ct]]$num_markers) -->

<!--     annot[[ct]]$analyte <- 'NA' -->
<!--     annot[[ct]][grepl('genes', annot[[ct]]$flavour), 'analyte'] <- 'genes' -->
<!--     annot[[ct]][grepl('repeats', annot[[ct]]$flavour), 'analyte'] <- 'repeats' -->
<!--     annot[[ct]][grepl('both', annot[[ct]]$flavour), 'analyte'] <- 'both' -->

<!--     annot[[ct]]$analyte <- factor(annot[[ct]]$analyte, levels = c('genes', 'both', 'repeats')) -->

<!--     annot[[ct]]$multimapper <- 'NA' -->
<!--     annot[[ct]][grepl('multi', annot[[ct]]$flavour), 'multimapper'] <- 'multi' -->
<!--     annot[[ct]][grepl('alevin', annot[[ct]]$flavour), 'multimapper'] <- 'deduplicated' -->
<!--     annot[[ct]][grepl('genes|cellranger|unique', annot[[ct]]$flavour), 'multimapper'] <- 'unique' -->

<!--     ## table(annot[[ct]]$analyte, annot[[ct]]$multimapper, useNA = 'always') -->

<!--     annot[[ct]]$overlap <- 'overlap_allowed' -->
<!--     annot[[ct]][grepl('repeats_alevin', annot[[ct]]$flavour), 'overlap'] <- 'alevin_decoy' -->
<!--     annot[[ct]][grepl('genes|both', annot[[ct]]$flavour), 'overlap'] <- 'genes' -->
<!--     annot[[ct]][grepl('only', annot[[ct]]$flavour), 'overlap'] <- 'no_overlap' -->

<!--     annot[[ct]]$mapper <- 'NA' -->
<!--     annot[[ct]][grepl('cellranger', annot[[ct]]$flavour), 'mapper'] <- 'cellranger' -->
<!--     annot[[ct]][grepl('star|featurecounts|only', annot[[ct]]$flavour), 'mapper'] <- 'star' -->
<!--     annot[[ct]][grepl('bowtie', annot[[ct]]$flavour), 'mapper'] <- 'bowtie' -->
<!--     annot[[ct]][grepl('alevin', annot[[ct]]$flavour), 'mapper'] <- 'alevin' -->
<!--     table(annot[[ct]]$mapper) -->

<!--     annot[[ct]]$counter <- 'featurecounts' -->
<!--     annot[[ct]][grepl('cellranger', annot[[ct]]$flavour), 'counter'] <- 'cellranger' -->
<!--     annot[[ct]][grepl('alevin', annot[[ct]]$flavour), 'counter'] <- 'alevin' -->

<!--     annot[[ct]]$technology <- 'chromium' -->
<!--     annot[[ct]][grepl('smartseq2', annot[[ct]]$dataset), 'technology'] <- 'smartseq2' -->
<!--     annot[[ct]][grepl('celseq', annot[[ct]]$dataset), 'technology'] <- 'celseq2' -->
<!--     annot[[ct]][grepl('dropseq', annot[[ct]]$dataset), 'technology'] <- 'dropseq' -->
<!--     annot[[ct]][grepl('seqwell', annot[[ct]]$dataset), 'technology'] <- 'seqwell' -->
<!-- } -->
...
<!--                         show_coltree = FALSE, -->
<!--                         rel_width = 2) + -->
<!--         labs(fill = "Hamming dist.") + -->
<!--         scale_fill_viridis_c(direction = -1) + -->
<!--         ## geom_th_addvalue(name = "hm0", color = "white", size = 2) + -->
<!--         geom_th_title(name = "hm0", side = "top", -->
<!--                       label = "Num. discordant markers (Hamming dist.)", nudge_y = -0.2) + -->
        
<!--         new_scale_fill() + -->
<!--         geom_th_heatmap(th_data = annot[[item]]['num_markers'], name = "hm6", gap = 0.2, -->
<!--                         rel_width = 0.1) + -->
<!--         labs(fill = "Num. markers")+ -->
<!--         scale_colour_gradient() + -->
<!--         geom_th_text(name = "hm6", side = "top", nudge_y = 0.8, -->
<!--                      angle = 90, size = 3) + -->

<!--     new_scale_fill() + -->
<!--     geom_th_heatmap(th_data = annot[[item]]['dataset'], name = "hm1", gap = 0.2,  -->
<!--                     cluster_column = FALSE, -->
<!--                     size_coltree = 0.5, -->
<!--                     rel_width = 0.1) + -->
...
<!--     new_scale_fill() + -->
<!--     geom_th_heatmap(th_data = annot[[item]]['technology'], name = "hmtech", gap = 0.2,  -->
<!--                     cluster_column = FALSE, -->
<!--                     size_coltree = 0.5, -->
<!--                     rel_width = 0.1) + -->
<!--     ## scale_fill_brewer(palette = "Set2") + -->
...
<!--     geom_th_text(name = "hmtech", side = "top", nudge_y = 0.8, -->
<!--                  angle = 90, size = 3) + -->

<!--     new_scale_fill() + -->
<!--     geom_th_heatmap(th_data = annot[[item]]['mapper'], name = "hm2", gap = 0.2,  -->
<!--                     cluster_column = FALSE, -->
<!--                     size_coltree = 0.5, -->
<!--                     rel_width = 0.1) + -->
...
<!--     new_scale_fill() + -->
<!--     geom_th_heatmap(th_data = annot[[item]]['counter'], name = "hm3", gap = 0.2,  -->
<!--                     cluster_column = FALSE, -->
<!--                     size_coltree = 0.5, -->
<!--                     rel_width = 0.1) + -->
...
<!--     new_scale_fill() + -->
<!--     geom_th_heatmap(th_data = annot[[item]]['overlap'], name = "hm4", gap = 0.2,  -->
<!--                     cluster_column = FALSE, -->
<!--                     size_coltree = 0.5, -->
<!--                     rel_width = 0.1) + -->
<!--     scale_fill_manual(values = setNames(palettes$overlap$color, palettes$overlap$id)) + -->
<!--     labs(fill = "Overlap") + -->
<!--     geom_th_text(name = "hm4", side = "top", nudge_y = 0.8, -->
<!--                  angle = 90, size = 3) + -->
<!--     new_scale_fill() + -->
    
<!--     geom_th_heatmap(th_data = annot[[item]]['multimapper'], name = "hm5", gap = 0.2,  -->
<!--                     cluster_column = FALSE, -->
<!--                     size_coltree = 0.5, -->
<!--                     rel_width = 0.1) + -->
<!--     scale_fill_manual(values = setNames(palettes$multimapper$color, palettes$multimapper$id)) + -->
<!--     labs(fill = "Multimappers")+ -->
<!--     geom_th_text(name = "hm5", side = "top", nudge_y = 0.8, -->
<!--                  angle = 90, size = 3) -->
...
<!--     leg12 <- plot_grid(leg[[1]], -->
<!--                        leg[[2]], -->
<!--                        ncol = 2, -->
<!--                        align = 'v') -->

<!--     leg13 <- plot_grid(leg12, leg[[3]], rel.heights = c(1, 0.9)) -->

<!--     ## (plot_grid(leg12) | plot_grid(leg[[3]])) +   -->
<!--     ##     plot_layout(guides = 'collect') & -->
<!--     ##     theme(legend.justification = "left") -->

<!--     ## (plot_grid(leg[[1]]) | plot_grid(leg[[2]]) | plot_grid(leg[[3]])) +   -->
<!--     ##     plot_layout(guides = 'collect') & -->
<!--     ##     theme(legend.justification = "left") -->
...
<!--     plot_grid(full + theme(legend.position = "none"), legs, -->
<!--               ncol = 2, -->
<!--               align = 'hv', -->
<!--               rel_widths = c(5, 1.5), -->
<!--               rel_heights = c(1, 0.6)) -->
