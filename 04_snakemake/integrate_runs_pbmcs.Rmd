...
## logFC representations

Also, do the top repeat markers show a difference in the bulk datasets? Maybe use log2FC?
...
```{r, fig.width = 10, fig.height = 10, results = 'asis'}
for (flavour in grep('repeats|both', unique(unlist(sapply(d, names))))){
    cat(sprintf('## %s  {.tabset .tabset-fade .tabset-pills} \n\n', flavour))
    p <- list()
