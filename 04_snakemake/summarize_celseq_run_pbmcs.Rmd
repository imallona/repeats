...
```{r subset}
d$genes_alevin <- subset(d$genes_alevin, subset = percent.mt < 10 | is.na(percent.mt))
...
for (item in names(d)) {
    ...
    print(DimPlot(d[[item]], reduction = "umap", group.by = 'seurat_clusters'))
    print(DimPlot(d[[item]], reduction = "tsne", group.by = 'seurat_clusters'))
