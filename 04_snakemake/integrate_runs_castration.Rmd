...
## Dimred PCA {.tabset .tabset-fade .tabset-pills}
...
## Dimred UMAP and tSNE {.tabset .tabset-fade .tabset-pills}

```{r results = 'asis', cache = FALSE, warning = FALSE, fig.width = 8, fig.height = 8}
for (item in names(d)) {
    cat("### ", item, " {.tabset} \n\n")
