...
d <- lapply(d, function(x) return(head(x, 2e5)[,1:100]))
...
## library(GenomicRanges)
## overlaps <- findOverlaps(query = GRanges(seqnames = d$shao$Chr,
##                                          ranges = IRanges(d$shao$Start, d$shao$End),
##                                          strand = '+',
##                                          feature = d$shao$feature),
...
## ## this works
## hits <- findOverlaps(query = GRanges(seqnames = d$shao$saf$Chr,
...
## counts <- countOverlaps(query = GRanges(seqnames = d$shao$saf$Chr,
##                                      ranges = IRanges(d$shao$saf$Start, d$shao$saf$End),
##                                      feature = d$shao$saf$GeneID),
##                      subject = GRanges(seqnames = paste0('chr', truth$chr),
##                                         ranges = IRanges(as.numeric(truth$start),
...
overlaps <- mergeByOverlaps(query = GRanges(seqnames = d$shao$saf$Chr,
                     ...
                     minoverlap = 30)
## this doesn't
## query_df <- GRanges::extractROWSq(query = GRanges(seqnames = d$shao$saf$Chr,
##                                         ranges = IRanges(d$shao$saf$Start, d$shao$saf$End),
##                                         feature = d$shao$saf$GeneID),
##                         queryHits(hits))
